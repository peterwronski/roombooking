...
<p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.
    ...
    Praesent dapibus, neque id cursus faucibus, tortor neque egestas augue, eu vulputate magna eros eu erat.
            Aliquam erat volutpat. Nam dui mi, tincidunt quis, accumsan porttitor, facilisis luctus, metus</p><br/>
       ...
       <div class="row">
           ...
           <div class="col-lg-4 col-lg-offset-4 loginform">
               <form action="login.php" method="POST">
                   ...
                   <input type="text" name="studentid" placeholder="Student ID" id="studentid" required/>
<br/>
