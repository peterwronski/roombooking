...
function getRoomByID($id){
    ...
    $roomInfo = array();
    global $conn;
    $getRoomByID_query = $conn -> mysqli_query ("SELECT room_id, room_name, room_size, room_desc FROM room WHERE room_id = $id' ");


    while($row = $getRoomByID_query -> mysqli_fetch_assoc()){
