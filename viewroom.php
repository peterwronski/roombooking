...
else // else take the app list
{
    ...
    <ul>
        <?php foreach ($roomList as $room): ?>
            <li>
                <a href=<?php echo "http://bookaroom.azurewebsites.net/viewroom.php?action=getRoomByID&id=" . $room["room_id"]  ?> alt=<?php echo "room_" . $room["room_id"] ?>><?php echo $room["room_name"] ?></a>
            </li>
        <?php endforeach; ?>
    </ul>
    <?php
